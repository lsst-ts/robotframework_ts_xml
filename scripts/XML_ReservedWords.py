...
for subsystem in xml_common.subsystems:
	...
	for xml in xmls:
		...
		print("Validate " + xml_common.CapitalizeSubsystem(subsystem) + " " + messageType + " EFDB_Name For IDL Reserved words")
		file.write("Validate " + xml_common.CapitalizeSubsystem(subsystem) + " " + messageType + " EFDB_Name For IDL Reserved words\n")
		...
		print("Validate " + xml_common.CapitalizeSubsystem(subsystem) + " " + messageType + " EFDB_Name For MySQL Reserved words")
		file.write("Validate " + xml_common.CapitalizeSubsystem(subsystem) + " " + messageType + " EFDB_Name For MySQL Reserved Words\n")
...
file.write("    \    Run Keyword And Continue On Failure    Should Not Contain    ${string}    ${SPACE}${word}${SPACE}\n")
file.write("\n")
