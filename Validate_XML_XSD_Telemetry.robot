...
Validate MtAtElectrometer Telemetry XML file
	[Tags]    smoke    MtAtElectrometer
	${output}=    Run    ${xml} val -e --xsd ${folder}/schema/SALTelemetrySet.xsd ${folder}/sal_interfaces/MtAtElectrometer/MtAtElectrometer_Telemetry.xml
	Log    ${output}
