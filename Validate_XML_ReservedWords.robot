...
*** Test Cases ***
Validate Archiver Events EFDB_Name For IDL Reserved words
...
Validate Archiver Events EFDB_Name For MySQL Reserved Words
...
Validate Archiver Telemetry EFDB_Name For IDL Reserved words
...
Validate Archiver Telemetry EFDB_Name For MySQL Reserved Words
...
Validate CalibrationElectrometer Commands EFDB_Name For IDL Reserved words
...
Validate CalibrationElectrometer Commands EFDB_Name For MySQL Reserved Words
...
Validate CalibrationElectrometer Events EFDB_Name For IDL Reserved words
...
Validate CalibrationElectrometer Events EFDB_Name For MySQL Reserved Words
...
Validate CalibrationElectrometer Telemetry EFDB_Name For IDL Reserved words
...
Validate CalibrationElectrometer Telemetry EFDB_Name For MySQL Reserved Words
...
Validate Camera Commands EFDB_Name For IDL Reserved words
...
Validate Camera Commands EFDB_Name For MySQL Reserved Words
...
Validate Camera Events EFDB_Name For IDL Reserved words
...
Validate Camera Events EFDB_Name For MySQL Reserved Words
...
Validate Camera Telemetry EFDB_Name For IDL Reserved words
...
Validate Camera Telemetry EFDB_Name For MySQL Reserved Words
...
Validate CatchupArchiver Events EFDB_Name For IDL Reserved words
...
Validate CatchupArchiver Events EFDB_Name For MySQL Reserved Words
...
Validate CatchupArchiver Telemetry EFDB_Name For IDL Reserved words
...
Validate CatchupArchiver Telemetry EFDB_Name For MySQL Reserved Words
...
Validate DMHeaderService Commands EFDB_Name For IDL Reserved words
...
Validate DMHeaderService Commands EFDB_Name For MySQL Reserved Words
...
Validate DMHeaderService Events EFDB_Name For IDL Reserved words
...
Validate DMHeaderService Events EFDB_Name For MySQL Reserved Words
...
Validate DMHeaderService Telemetry EFDB_Name For IDL Reserved words
...
Validate DMHeaderService Telemetry EFDB_Name For MySQL Reserved Words
...
Validate Dome Commands EFDB_Name For IDL Reserved words
...
Validate Dome Commands EFDB_Name For MySQL Reserved Words
...
Validate Dome Events EFDB_Name For IDL Reserved words
...
Validate Dome Events EFDB_Name For MySQL Reserved Words
...
Validate Dome Telemetry EFDB_Name For IDL Reserved words
...
Validate Dome Telemetry EFDB_Name For MySQL Reserved Words
...
Validate DomeADB Commands EFDB_Name For IDL Reserved words
...
Validate DomeADB Commands EFDB_Name For MySQL Reserved Words
...
Validate DomeADB Events EFDB_Name For IDL Reserved words
...
Validate DomeADB Events EFDB_Name For MySQL Reserved Words
...
Validate DomeADB Telemetry EFDB_Name For IDL Reserved words
...
Validate DomeADB Telemetry EFDB_Name For MySQL Reserved Words
...
Validate DomeAPS Commands EFDB_Name For IDL Reserved words
...
Validate DomeAPS Commands EFDB_Name For MySQL Reserved Words
...
Validate DomeAPS Events EFDB_Name For IDL Reserved words
...
Validate DomeAPS Events EFDB_Name For MySQL Reserved Words
...
Validate DomeAPS Telemetry EFDB_Name For IDL Reserved words
...
Validate DomeAPS Telemetry EFDB_Name For MySQL Reserved Words
...
Validate DomeLouvers Commands EFDB_Name For IDL Reserved words
...
Validate DomeLouvers Commands EFDB_Name For MySQL Reserved Words
...
Validate DomeLouvers Events EFDB_Name For IDL Reserved words
...
Validate DomeLouvers Events EFDB_Name For MySQL Reserved Words
...
Validate DomeLouvers Telemetry EFDB_Name For IDL Reserved words
...
Validate DomeLouvers Telemetry EFDB_Name For MySQL Reserved Words
...
Validate DomeLWS Commands EFDB_Name For IDL Reserved words
...
Validate DomeLWS Commands EFDB_Name For MySQL Reserved Words
...
Validate DomeLWS Events EFDB_Name For IDL Reserved words
...
Validate DomeLWS Events EFDB_Name For MySQL Reserved Words
...
Validate DomeLWS Telemetry EFDB_Name For IDL Reserved words
...
Validate DomeLWS Telemetry EFDB_Name For MySQL Reserved Words
...
Validate DomeMONCS Commands EFDB_Name For IDL Reserved words
...
Validate DomeMONCS Commands EFDB_Name For MySQL Reserved Words
...
Validate DomeMONCS Events EFDB_Name For IDL Reserved words
...
Validate DomeMONCS Events EFDB_Name For MySQL Reserved Words
...
Validate DomeMONCS Telemetry EFDB_Name For IDL Reserved words
...
Validate DomeMONCS Telemetry EFDB_Name For MySQL Reserved Words
...
Validate DomeTHCS Commands EFDB_Name For IDL Reserved words
...
Validate DomeTHCS Commands EFDB_Name For MySQL Reserved Words
...
Validate DomeTHCS Events EFDB_Name For IDL Reserved words
...
Validate DomeTHCS Events EFDB_Name For MySQL Reserved Words
...
Validate DomeTHCS Telemetry EFDB_Name For IDL Reserved words
...
Validate DomeTHCS Telemetry EFDB_Name For MySQL Reserved Words
...
Validate EEC Commands EFDB_Name For IDL Reserved words
...
Validate EEC Commands EFDB_Name For MySQL Reserved Words
...
Validate EEC Events EFDB_Name For IDL Reserved words
...
Validate EEC Events EFDB_Name For MySQL Reserved Words
...
Validate EEC Telemetry EFDB_Name For IDL Reserved words
...
Validate EEC Telemetry EFDB_Name For MySQL Reserved Words
...
Validate Environment Telemetry EFDB_Name For IDL Reserved words
...
Validate Environment Telemetry EFDB_Name For MySQL Reserved Words
...
Validate Hexapod Commands EFDB_Name For IDL Reserved words
...
Validate Hexapod Commands EFDB_Name For MySQL Reserved Words
...
Validate Hexapod Events EFDB_Name For IDL Reserved words
...
Validate Hexapod Events EFDB_Name For MySQL Reserved Words
...
Validate Hexapod Telemetry EFDB_Name For IDL Reserved words
...
Validate Hexapod Telemetry EFDB_Name For MySQL Reserved Words
...
Validate M1M3 Commands EFDB_Name For IDL Reserved words
...
Validate M1M3 Commands EFDB_Name For MySQL Reserved Words
...
Validate M1M3 Events EFDB_Name For IDL Reserved words
...
Validate M1M3 Events EFDB_Name For MySQL Reserved Words
...
Validate M1M3 Telemetry EFDB_Name For IDL Reserved words
...
Validate M1M3 Telemetry EFDB_Name For MySQL Reserved Words
...
Validate M2MS Commands EFDB_Name For IDL Reserved words
...
Validate M2MS Commands EFDB_Name For MySQL Reserved Words
...
Validate M2MS Events EFDB_Name For IDL Reserved words
...
Validate M2MS Events EFDB_Name For MySQL Reserved Words
...
Validate M2MS Telemetry EFDB_Name For IDL Reserved words
...
Validate M2MS Telemetry EFDB_Name For MySQL Reserved Words
...
Validate MTMount Commands EFDB_Name For IDL Reserved words
...
Validate MTMount Commands EFDB_Name For MySQL Reserved Words
...
Validate MTMount Events EFDB_Name For IDL Reserved words
...
Validate MTMount Events EFDB_Name For MySQL Reserved Words
...
Validate MTMount Telemetry EFDB_Name For IDL Reserved words
...
Validate MTMount Telemetry EFDB_Name For MySQL Reserved Words
...
Validate OCS Commands EFDB_Name For IDL Reserved words
...
Validate OCS Commands EFDB_Name For MySQL Reserved Words
...
Validate OCS Events EFDB_Name For IDL Reserved words
...
Validate OCS Events EFDB_Name For MySQL Reserved Words
...
Validate OCS Telemetry EFDB_Name For IDL Reserved words
...
Validate OCS Telemetry EFDB_Name For MySQL Reserved Words
...
Validate ProcessingCluster Events EFDB_Name For IDL Reserved words
	[Documentation]    Validate the ProcessingCluster Events <EFDB_Name> tags do not contain IDL Reserved Words.
	[Tags]    smoke
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/EFDB_Name" -v . -n ${folder}/sal_interfaces/processingcluster/processingcluster_Events.xml |awk '{$1=$1};1' |uniq |tr '\n' '|'
	Log    ${output}
	Should Not Contain IDL Reserved Word    ${output}

Validate ProcessingCluster Events EFDB_Name For MySQL Reserved Words
	[Documentation]    Validate the ProcessingCluster Events <EFDB_Name> tags do not contain MySQL Reserved Words.
	[Tags]    smoke
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/EFDB_Name" -v . -n ${folder}/sal_interfaces/processingcluster/processingcluster_Events.xml |awk '{$1=$1};1' |uniq |tr '\n' '|'
	Log    ${output}
	Should Not Contain MySQL Reserved Word    ${output}

Validate ProcessingCluster Telemetry EFDB_Name For IDL Reserved words
	[Documentation]    Validate the ProcessingCluster Telemetry <EFDB_Name> tags do not contain IDL Reserved Words.
	[Tags]    smoke
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/EFDB_Name" -v . -n ${folder}/sal_interfaces/processingcluster/processingcluster_Telemetry.xml |awk '{$1=$1};1' |uniq |tr '\n' '|'
	Log    ${output}
	Should Not Contain IDL Reserved Word    ${output}

Validate ProcessingCluster Telemetry EFDB_Name For MySQL Reserved Words
	[Documentation]    Validate the ProcessingCluster Telemetry <EFDB_Name> tags do not contain MySQL Reserved Words.
	[Tags]    smoke
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/EFDB_Name" -v . -n ${folder}/sal_interfaces/processingcluster/processingcluster_Telemetry.xml |awk '{$1=$1};1' |uniq |tr '\n' '|'
	Log    ${output}
	Should Not Contain MySQL Reserved Word    ${output}

Validate Rotator Commands EFDB_Name For IDL Reserved words
...
Validate Rotator Commands EFDB_Name For MySQL Reserved Words
...
Validate Rotator Events EFDB_Name For IDL Reserved words
...
Validate Rotator Events EFDB_Name For MySQL Reserved Words
...
Validate Rotator Telemetry EFDB_Name For IDL Reserved words
...
Validate Rotator Telemetry EFDB_Name For MySQL Reserved Words
...
Validate Scheduler Telemetry EFDB_Name For IDL Reserved words
...
Validate Scheduler Telemetry EFDB_Name For MySQL Reserved Words
...
Validate Sequencer Commands EFDB_Name For IDL Reserved words
...
Validate Sequencer Commands EFDB_Name For MySQL Reserved Words
...
Validate Sequencer Events EFDB_Name For IDL Reserved words
...
Validate Sequencer Events EFDB_Name For MySQL Reserved Words
...
Validate Sequencer Telemetry EFDB_Name For IDL Reserved words
...
Validate Sequencer Telemetry EFDB_Name For MySQL Reserved Words
...
Validate SummitFacility Commands EFDB_Name For IDL Reserved words
...
Validate SummitFacility Commands EFDB_Name For MySQL Reserved Words
...
Validate SummitFacility Events EFDB_Name For IDL Reserved words
...
Validate SummitFacility Events EFDB_Name For MySQL Reserved Words
...
Validate SummitFacility Telemetry EFDB_Name For IDL Reserved words
...
Validate SummitFacility Telemetry EFDB_Name For MySQL Reserved Words
...
Validate TCS Commands EFDB_Name For IDL Reserved words
...
Validate TCS Commands EFDB_Name For MySQL Reserved Words
...
Validate TCS Events EFDB_Name For IDL Reserved words
...
Validate TCS Events EFDB_Name For MySQL Reserved Words
...
Validate TCS Telemetry EFDB_Name For IDL Reserved words
...
Validate TCS Telemetry EFDB_Name For MySQL Reserved Words
...
Validate TCSAOCS Commands EFDB_Name For IDL Reserved words
...
Validate TCSAOCS Commands EFDB_Name For MySQL Reserved Words
...
Validate TCSAOCS Events EFDB_Name For IDL Reserved words
...
Validate TCSAOCS Events EFDB_Name For MySQL Reserved Words
...
Validate TCSAOCS Telemetry EFDB_Name For IDL Reserved words
...
Validate TCSAOCS Telemetry EFDB_Name For MySQL Reserved Words
...
Validate TCSWEP Events EFDB_Name For IDL Reserved words
...
Validate TCSWEP Events EFDB_Name For MySQL Reserved Words
...
Validate TCSWEP Telemetry EFDB_Name For IDL Reserved words
...
Validate TCSWEP Telemetry EFDB_Name For MySQL Reserved Words
...
Validate VMS Commands EFDB_Name For IDL Reserved words
...
Validate VMS Commands EFDB_Name For MySQL Reserved Words
...
Validate VMS Events EFDB_Name For IDL Reserved words
...
Validate VMS Events EFDB_Name For MySQL Reserved Words
...
Validate VMS Telemetry EFDB_Name For IDL Reserved words
...
Validate VMS Telemetry EFDB_Name For MySQL Reserved Words
...
Should Not Contain IDL Reserved Word
    ...
    \    Run Keyword And Continue On Failure    Should Not Contain    ${string}    ${SPACE}${word}${SPACE}
