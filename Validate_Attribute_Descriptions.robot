...
Validate ATAOS Commands Attribute Descriptions
	...
	[Tags]    smoke    ATAOS
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/ATAOS/ATAOS_Commands.xml |tr '\\n' '|'
	Log    ${output}
...
Validate ATAOS Events Attribute Descriptions
	...
	[Tags]    smoke    ATAOS
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/ATAOS/ATAOS_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATAOS Telemetry Attribute Descriptions
	...
	[Tags]    smoke    ATAOS
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/ATAOS/ATAOS_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATArchiver Commands Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/ATArchiver/ATArchiver_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATArchiver Events Attribute Descriptions
	...
	[Tags]    smoke    ATArchiver
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/ATArchiver/ATArchiver_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATArchiver Telemetry Attribute Descriptions
	...
	[Tags]    smoke    ATArchiver
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/ATArchiver/ATArchiver_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATBuilding Events Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/ATBuilding/ATBuilding_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATBuilding Telemetry Attribute Descriptions
	...
	[Tags]    smoke    ATBuilding
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/ATBuilding/ATBuilding_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATCamera Commands Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/ATCamera/ATCamera_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATCamera Events Attribute Descriptions
	...
	[Tags]    smoke    ATCamera    CAP-318
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/ATCamera/ATCamera_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATCamera Telemetry Attribute Descriptions
	...
	[Tags]    smoke    ATCamera    CAP-318
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/ATCamera/ATCamera_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATDome Commands Attribute Descriptions
	...
	[Tags]    smoke    ATDome
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/ATDome/ATDome_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATDome Events Attribute Descriptions
	...
	[Tags]    smoke    ATDome
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/ATDome/ATDome_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATDome Telemetry Attribute Descriptions
	...
	[Tags]    smoke    ATDome
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/ATDome/ATDome_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATDomeTrajectory Events Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/ATDomeTrajectory/ATDomeTrajectory_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATHeaderService Events Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/ATHeaderService/ATHeaderService_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATHexapod Commands Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/ATHexapod/ATHexapod_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATHexapod Events Attribute Descriptions
	...
	[Tags]    smoke    ATHexapod
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/ATHexapod/ATHexapod_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATHexapod Telemetry Attribute Descriptions
	...
	[Tags]    smoke    ATHexapod
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/ATHexapod/ATHexapod_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATMCS Commands Attribute Descriptions
	...
	[Tags]    smoke    ATMCS
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/ATMCS/ATMCS_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATMCS Events Attribute Descriptions
	...
	[Tags]    smoke    ATMCS
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/ATMCS/ATMCS_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATMCS Telemetry Attribute Descriptions
	...
	[Tags]    smoke    ATMCS
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/ATMCS/ATMCS_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATMonochromator Commands Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/ATMonochromator/ATMonochromator_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATMonochromator Events Attribute Descriptions
	...
	[Tags]    smoke    ATMonochromator
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/ATMonochromator/ATMonochromator_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATMonochromator Telemetry Attribute Descriptions
	...
	[Tags]    smoke    ATMonochromator
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/ATMonochromator/ATMonochromator_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATPneumatics Commands Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/ATPneumatics/ATPneumatics_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATPneumatics Events Attribute Descriptions
	...
	[Tags]    smoke    ATPneumatics
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/ATPneumatics/ATPneumatics_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATPneumatics Telemetry Attribute Descriptions
	...
	[Tags]    smoke    ATPneumatics
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/ATPneumatics/ATPneumatics_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATPtg Commands Attribute Descriptions
	...
	[Tags]    smoke    ATPtg
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/ATPtg/ATPtg_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATPtg Events Attribute Descriptions
	...
	[Tags]    smoke    ATPtg
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/ATPtg/ATPtg_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATPtg Telemetry Attribute Descriptions
	...
	[Tags]    smoke    ATPtg
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/ATPtg/ATPtg_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATSpectrograph Commands Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/ATSpectrograph/ATSpectrograph_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATSpectrograph Events Attribute Descriptions
	...
	[Tags]    smoke    ATSpectrograph
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/ATSpectrograph/ATSpectrograph_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATSpectrograph Telemetry Attribute Descriptions
	...
	[Tags]    smoke    ATSpectrograph
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/ATSpectrograph/ATSpectrograph_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATTCS Commands Attribute Descriptions
	...
	[Tags]    smoke    ATTCS
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/ATTCS/ATTCS_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATTCS Events Attribute Descriptions
	...
	[Tags]    smoke    ATTCS
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/ATTCS/ATTCS_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATTCS Telemetry Attribute Descriptions
	...
	[Tags]    smoke    ATTCS
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/ATTCS/ATTCS_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATWhiteLight Commands Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/ATWhiteLight/ATWhiteLight_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATWhiteLight Events Attribute Descriptions
	...
	[Tags]    smoke    ATWhiteLight
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/ATWhiteLight/ATWhiteLight_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ATWhiteLight Telemetry Attribute Descriptions
	...
	[Tags]    smoke    ATWhiteLight
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/ATWhiteLight/ATWhiteLight_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate CatchupArchiver Events Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/CatchupArchiver/CatchupArchiver_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate CatchupArchiver Telemetry Attribute Descriptions
	...
	[Tags]    smoke    CatchupArchiver
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/CatchupArchiver/CatchupArchiver_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate CBP Commands Attribute Descriptions
	...
	[Tags]    smoke    CBP
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/CBP/CBP_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate CBP Telemetry Attribute Descriptions
	...
	[Tags]    smoke    CBP
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/CBP/CBP_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate DIMM Events Attribute Descriptions
	...
	[Tags]    smoke    DIMM
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/DIMM/DIMM_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate DIMM Telemetry Attribute Descriptions
	...
	[Tags]    smoke    DIMM
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/DIMM/DIMM_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Dome Commands Attribute Descriptions
	...
	[Tags]    smoke    Dome
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/Dome/Dome_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Dome Events Attribute Descriptions
	...
	[Tags]    smoke    Dome
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/Dome/Dome_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Dome Telemetry Attribute Descriptions
	...
	[Tags]    smoke    Dome
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/Dome/Dome_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate DSM Events Attribute Descriptions
	...
	[Tags]    smoke    DSM
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/DSM/DSM_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate DSM Telemetry Attribute Descriptions
	...
	[Tags]    smoke    DSM
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/DSM/DSM_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate EAS Events Attribute Descriptions
	...
	[Tags]    smoke    EAS
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/EAS/EAS_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate EAS Telemetry Attribute Descriptions
	...
	[Tags]    smoke    EAS
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/EAS/EAS_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate EFD Events Attribute Descriptions
	...
	[Tags]    smoke    EFD
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/EFD/EFD_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate EFD Telemetry Attribute Descriptions
	...
	[Tags]    smoke    EFD
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/EFD/EFD_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate EFDTransformationServer Events Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/EFDTransformationServer/EFDTransformationServer_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate EFDTransformationServer Telemetry Attribute Descriptions
	...
	[Tags]    smoke    EFDTransformationServer
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/EFDTransformationServer/EFDTransformationServer_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Electrometer Commands Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/Electrometer/Electrometer_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Electrometer Events Attribute Descriptions
	...
	[Tags]    smoke    Electrometer
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/Electrometer/Electrometer_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Environment Telemetry Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/Environment/Environment_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate FiberSpectrograph Commands Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/FiberSpectrograph/FiberSpectrograph_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate FiberSpectrograph Events Attribute Descriptions
	...
	[Tags]    smoke    FiberSpectrograph
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/FiberSpectrograph/FiberSpectrograph_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate FiberSpectrograph Telemetry Attribute Descriptions
	...
	[Tags]    smoke    FiberSpectrograph
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/FiberSpectrograph/FiberSpectrograph_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate GenericCamera Commands Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/GenericCamera/GenericCamera_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate GenericCamera Events Attribute Descriptions
	...
	[Tags]    smoke    GenericCamera
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/GenericCamera/GenericCamera_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate GenericCamera Telemetry Attribute Descriptions
	...
	[Tags]    smoke    GenericCamera
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/GenericCamera/GenericCamera_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate IOTA Events Attribute Descriptions
	...
	[Tags]    smoke    IOTA
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/IOTA/IOTA_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate IOTA Telemetry Attribute Descriptions
	...
	[Tags]    smoke    IOTA
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/IOTA/IOTA_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Hexapod Commands Attribute Descriptions
	...
	[Tags]    smoke    Hexapod    DM-20971
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/Hexapod/Hexapod_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Hexapod Events Attribute Descriptions
	...
	[Tags]    smoke    Hexapod    DM-20971
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/Hexapod/Hexapod_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Hexapod Telemetry Attribute Descriptions
	...
	[Tags]    smoke    Hexapod    DM-20971
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/Hexapod/Hexapod_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate HVAC Commands Attribute Descriptions
	...
	[Tags]    smoke    HVAC
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/HVAC/HVAC_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate HVAC Events Attribute Descriptions
	...
	[Tags]    smoke    HVAC
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/HVAC/HVAC_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate HVAC Telemetry Attribute Descriptions
	...
	[Tags]    smoke    HVAC
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/HVAC/HVAC_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate LinearStage Commands Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/LinearStage/LinearStage_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate LinearStage Events Attribute Descriptions
	...
	[Tags]    smoke    LinearStage
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/LinearStage/LinearStage_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate LinearStage Telemetry Attribute Descriptions
	...
	[Tags]    smoke    LinearStage
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/LinearStage/LinearStage_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate LOVE Events Attribute Descriptions
	...
	[Tags]    smoke    LOVE
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/LOVE/LOVE_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTAOS Commands Attribute Descriptions
	...
	[Tags]    smoke    MTAOS
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/MTAOS/MTAOS_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTAOS Events Attribute Descriptions
	...
	[Tags]    smoke    MTAOS
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/MTAOS/MTAOS_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTAOS Telemetry Attribute Descriptions
	...
	[Tags]    smoke    MTAOS
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/MTAOS/MTAOS_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTArchiver Events Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/MTArchiver/MTArchiver_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTArchiver Telemetry Attribute Descriptions
	...
	[Tags]    smoke    MTArchiver
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/MTArchiver/MTArchiver_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTCamera Commands Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/MTCamera/MTCamera_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTCamera Events Attribute Descriptions
	...
	[Tags]    smoke    MTCamera    CAP-318
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/MTCamera/MTCamera_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTCamera Telemetry Attribute Descriptions
	...
	[Tags]    smoke    MTCamera    CAP-318
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/MTCamera/MTCamera_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTDomeTrajectory Events Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/MTDomeTrajectory/MTDomeTrajectory_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTDomeTrajectory Telemetry Attribute Descriptions
	...
	[Tags]    smoke    MTDomeTrajectory
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/MTDomeTrajectory/MTDomeTrajectory_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTEEC Commands Attribute Descriptions
	...
	[Tags]    smoke    MTEEC    CAP-374
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/MTEEC/MTEEC_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTEEC Events Attribute Descriptions
	...
	[Tags]    smoke    MTEEC    CAP-374
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/MTEEC/MTEEC_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTGuider Events Attribute Descriptions
	...
	[Tags]    smoke    MTGuider
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/MTGuider/MTGuider_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTGuider Telemetry Attribute Descriptions
	...
	[Tags]    smoke    MTGuider
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/MTGuider/MTGuider_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTHeaderService Events Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/MTHeaderService/MTHeaderService_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTLaserTracker Events Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/MTLaserTracker/MTLaserTracker_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTLaserTracker Telemetry Attribute Descriptions
	...
	[Tags]    smoke    MTLaserTracker
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/MTLaserTracker/MTLaserTracker_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTM1M3 Commands Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/MTM1M3/MTM1M3_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTM1M3 Events Attribute Descriptions
	...
	[Tags]    smoke    MTM1M3    DM-20956
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/MTM1M3/MTM1M3_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTM1M3 Telemetry Attribute Descriptions
	...
	[Tags]    smoke    MTM1M3    DM-20956
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/MTM1M3/MTM1M3_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTM1M3TS Commands Attribute Descriptions
	...
	[Tags]    smoke    MTM1M3TS
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/MTM1M3TS/MTM1M3TS_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTM1M3TS Events Attribute Descriptions
	...
	[Tags]    smoke    MTM1M3TS
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/MTM1M3TS/MTM1M3TS_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTM1M3TS Telemetry Attribute Descriptions
	...
	[Tags]    smoke    MTM1M3TS
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/MTM1M3TS/MTM1M3TS_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTM2 Commands Attribute Descriptions
	...
	[Tags]    smoke    MTM2
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/MTM2/MTM2_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTM2 Events Attribute Descriptions
	...
	[Tags]    smoke    MTM2
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/MTM2/MTM2_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTM2 Telemetry Attribute Descriptions
	...
	[Tags]    smoke    MTM2
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/MTM2/MTM2_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTMount Commands Attribute Descriptions
	...
	[Tags]    smoke    MTMount
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/MTMount/MTMount_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTMount Events Attribute Descriptions
	...
	[Tags]    smoke    MTMount
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/MTMount/MTMount_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTMount Telemetry Attribute Descriptions
	...
	[Tags]    smoke    MTMount
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/MTMount/MTMount_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTPtg Commands Attribute Descriptions
	...
	[Tags]    smoke    MTPtg
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/MTPtg/MTPtg_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTPtg Events Attribute Descriptions
	...
	[Tags]    smoke    MTPtg
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/MTPtg/MTPtg_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTPtg Telemetry Attribute Descriptions
	...
	[Tags]    smoke    MTPtg
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/MTPtg/MTPtg_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTTCS Commands Attribute Descriptions
	...
	[Tags]    smoke    MTTCS
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/MTTCS/MTTCS_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTTCS Events Attribute Descriptions
	...
	[Tags]    smoke    MTTCS
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/MTTCS/MTTCS_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTTCS Telemetry Attribute Descriptions
	...
	[Tags]    smoke    MTTCS
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/MTTCS/MTTCS_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTVMS Commands Attribute Descriptions
	...
	[Tags]    smoke    MTVMS
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/MTVMS/MTVMS_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTVMS Events Attribute Descriptions
	...
	[Tags]    smoke    MTVMS
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/MTVMS/MTVMS_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate MTVMS Telemetry Attribute Descriptions
	...
	[Tags]    smoke    MTVMS
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/MTVMS/MTVMS_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate OCS Commands Attribute Descriptions
	...
	[Tags]    smoke    OCS
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/OCS/OCS_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate OCS Events Attribute Descriptions
	...
	[Tags]    smoke    OCS
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/OCS/OCS_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate OCS Telemetry Attribute Descriptions
	...
	[Tags]    smoke    OCS
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/OCS/OCS_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate PointingComponent Commands Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/PointingComponent/PointingComponent_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate PointingComponent Events Attribute Descriptions
	...
	[Tags]    smoke    PointingComponent
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/PointingComponent/PointingComponent_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate PointingComponent Telemetry Attribute Descriptions
	...
	[Tags]    smoke    PointingComponent
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/PointingComponent/PointingComponent_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate PromptProcessing Events Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/PromptProcessing/PromptProcessing_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate PromptProcessing Telemetry Attribute Descriptions
	...
	[Tags]    smoke    PromptProcessing
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/PromptProcessing/PromptProcessing_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Rotator Commands Attribute Descriptions
	...
	[Tags]    smoke    Rotator
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/Rotator/Rotator_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Rotator Events Attribute Descriptions
	...
	[Tags]    smoke    Rotator
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/Rotator/Rotator_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Rotator Telemetry Attribute Descriptions
	...
	[Tags]    smoke    Rotator
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/Rotator/Rotator_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Scheduler Events Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/Scheduler/Scheduler_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Scheduler Telemetry Attribute Descriptions
	...
	[Tags]    smoke    Scheduler
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/Scheduler/Scheduler_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Script Commands Attribute Descriptions
	...
	[Tags]    smoke    Script
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/Script/Script_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Script Events Attribute Descriptions
	...
	[Tags]    smoke    Script
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/Script/Script_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ScriptQueue Commands Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/ScriptQueue/ScriptQueue_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate ScriptQueue Events Attribute Descriptions
	...
	[Tags]    smoke    ScriptQueue
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/ScriptQueue/ScriptQueue_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate SummitFacility Telemetry Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/SummitFacility/SummitFacility_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Test Commands Attribute Descriptions
	...
	[Tags]    smoke    Test
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/Test/Test_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Test Events Attribute Descriptions
	...
	[Tags]    smoke    Test
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/Test/Test_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Test Telemetry Attribute Descriptions
	...
	[Tags]    smoke    Test
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/Test/Test_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate TunableLaser Commands Attribute Descriptions
	...
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/TunableLaser/TunableLaser_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate TunableLaser Events Attribute Descriptions
	...
	[Tags]    smoke    TunableLaser
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/TunableLaser/TunableLaser_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate TunableLaser Telemetry Attribute Descriptions
	...
	[Tags]    smoke    TunableLaser
	${output}=    Run    ${xml} sel -t -m "//SALTelemetrySet/SALTelemetry/item/Description" -v . -n ${folder}/sal_interfaces/TunableLaser/TunableLaser_Telemetry.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Watcher Commands Attribute Descriptions
	...
	[Tags]    smoke    Watcher
	${output}=    Run    ${xml} sel -t -m "//SALCommandSet/SALCommand/item/Description" -v . -n ${folder}/sal_interfaces/Watcher/Watcher_Commands.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
...
Validate Watcher Events Attribute Descriptions
	...
	[Tags]    smoke    Watcher
	${output}=    Run    ${xml} sel -t -m "//SALEventSet/SALEvent/item/Description" -v . -n ${folder}/sal_interfaces/Watcher/Watcher_Events.xml |tr '\\n' '|'
	Log    ${output}
	Should Not Contain    ${output}    ||    msg=Contains unpopulated descriptions.    values=False
	Should Not Start With    ${output}    |    msg=Contains unpopulated descriptions.    values=False
